...
// create a new event
apiv1.post('/events', auth.authenticate, validator.eventValidation, EventsController.createEvent)
...
apiv1.put('/events/:id', auth.authenticate, validator.eventValidation, EventsController.editEvent)
// delete an event
apiv1.delete('/events/:id', auth.authenticate, EventsController.deleteEvent)

// add new center
apiv1.post('/centers', auth.authenticate, validator.centerValidation, CentersController.createCenter)
// edit a center's details
apiv1.put('/centers/:id', auth.authenticate, validator.centerValidation, CentersController.modifyCenter)
// get all centers
