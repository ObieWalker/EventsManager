...
module.exports = describe('Tests for the centers', () => {
  describe('Adding a new center', () => {
    it('should return a status 403 error response due to no admin token', (done) => {
      chai
        .request(app)
        .post('/api/v1/centers')
        .send({
          ...
          facility: `This facility contains a Swimming pool and ${faker.lorem.sentence}`,
    ...
    it('should return a status 403 error response due to unauthenticated token', (done) => {
      chai
        .request(app)
    ...
    it('should return a status 400 error response missing a city name', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
    ...
    it('should return a status 400 error response empty address field', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
    ...
    it('should return a status 400 error response for empty capacity input', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
    ...
    it('should return a status 400 error response for string capacity input', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
    ...
    it('should return a status 400 error response for capacity input less than 10', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
    ...
    it('should return a status 201 response for adding a new center', (done) => {
      chai
        .request(app)
        .post(`/api/v1/centers?token=${helper.adminToken}`)
        .send({
  ...
  describe('Getting centers', () => {
    it('should return a status 200 success response for getting centers', (done) => {
      chai
        .request(app)
        .get('/api/v1/centers')
        .end((err, res) => {
    ...
    it('should return a status 200 success response with center length of 6 for default limit', (done) => {
      chai
        .request(app)
        .get('/api/v1/centers')
        .end((err, res) => {
    ...
    it('should return a status 200 success response with center length 3 due to limit', (done) => {
      chai
        .request(app)
    ...
    it('should return a status 200 success response for getting a center', (done) => {
      chai
        .request(app)
    ...
    it('should return a status 400 error response for a get center request that does not exist', (done) => {
      chai
        .request(app)
        ...
        .end((err, res) => {
          ...
          res.should.be.a('object');
          res.body.should.have.property('message').equal('We do not have records of this center');
          done();
        });
    });

    it('should return a status 400 error response for invalid center id type', (done) => {
      chai
        .request(app)
  ...
  describe('Test to delete centers', () => {
    ...
    it('should return a status 400 error response for no such center', (done) => {
      chai
        .request(app)
    ...
    it('should return a status 200 error response for successfully deleting center', (done) => {
      chai
        .request(app)
        .delete(`/api/v1/centers/${helper.centerId}?token=${helper.adminToken}`)
        .end((err, res) => {
          res.should.have.status(200);
          res.should.be.a('object');
