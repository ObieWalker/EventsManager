                      ...
                      <div className="col-sm-12">
                        <ul className="list-group">
                          ...
                          <li className="list-group-item text-right"><span
                            className="pull-left"><strong
                              className="">Name</strong></span>
                          {user.firstName} {user.lastName}</li>
                          <li className="list-group-item text-right"><span
                            className="pull-left"><strong
                              className="">Joined</strong></span>
                          {moment(user.createdAt).format('ll')}</li>
                          <li className="list-group-item text-right"><span
                            className="pull-left"><strong
                              className="">Last login</strong></span>
                          {moment(user.loginTime).fromNow()}</li>
                          <li className="list-group-item text-right"><span
                            className="pull-left"><strong
                              className="">Username</strong></span>
                          {user.username}</li>
                          <li className="list-group-item text-right"><span
                            className="pull-left">
                            <strong className="">Account Type </strong></span>
