...
import ModifyCenterForm from './ModifyCenterModal.jsx';
...
export class AdminCenters extends Component {
   ...
   */
  componentDidMount() {
    this.props.getAllCenters(this.state.pageNo, this.state.limit).then(() => {
      ...
      <div>
        <div>
          <div className="center col s12 m12">
            ...
            <div>
              <div>
                {this.props.allCenters.fetchedCenters ? (
                  <table
                    ...
                    <tbody>
                      {this.props.allCenters.fetchedCenters.map((center, i) => (
                        ...
                        >
                          ...
                          <td>
                            <button
                              onClick={this.handleModify.bind(this, center)}
                              type="button"
                          ...
                          <td>
                            <button
                              ...
                              type="button"
                              className="btn-danger btn-sm cool"
                            >
                              Delete
                            </button>
                          </td>
